    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white z-1">
      <div className="w-full max-w-sm bg-gradient-to-b from-sky-50/50 to-white rounded-3xl shadow-xl p-8 flex flex-col items-center border border-blue-100 text-black">
        ...
        <p className="text-gray-500 text-sm mb-6 text-center">
          Sign in to access your Label Origin project dashboard, formulation documents, and QA reports.
        </p>
        <div className="w-full flex flex-col gap-3 mb-2">
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <button className="text-xs hover:underline font-medium ml-auto">
              Forgot password?
            </button>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-400 mt-6 text-center">
          Don&apos;t have access?{" "}
          <a href="/#contact" className="text-[#0071e3] hover:underline">
            Contact us
          </a>
        </p>
      </div>
