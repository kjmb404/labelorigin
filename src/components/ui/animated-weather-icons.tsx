...
export function RainIcon({ size = 48, className }: WeatherIconProps) {
  const drops = [{ x: 16, d: 0 }, { x: 22, d: 0.3 }, { x: 28, d: 0.6 }, { x: 34, d: 0.15 }];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function HeavyRainIcon({ size = 48, className }: WeatherIconProps) {
  const drops = [{ x: 14, d: 0 }, { x: 19, d: 0.15 }, { x: 24, d: 0.3 }, { x: 29, d: 0.1 }, { x: 34, d: 0.4 }, { x: 37, d: 0.25 }];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function SnowIcon({ size = 48, className }: WeatherIconProps) {
  const flakes = [{ x: 16, d: 0 }, { x: 22, d: 0.5 }, { x: 28, d: 0.2 }, { x: 34, d: 0.7 }, { x: 19, d: 1.0 }, { x: 31, d: 0.4 }];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function WindIcon({ size = 48, className }: WeatherIconProps) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      ...
      <motion.path d="M10 30h18" stroke="#94A3B8" strokeWidth={2} strokeLinecap="round" opacity={0.5}
...
export function FogIcon({ size = 48, className }: WeatherIconProps) {
  const lines = [{ y: 16, w: 28, d: 0 }, { y: 22, w: 32, d: 0.5 }, { y: 28, w: 24, d: 1.0 }, { y: 34, w: 30, d: 1.5 }];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      {lines.map((l) => (
...
export function RainbowIcon({ size = 48, className }: WeatherIconProps) {
  const arcs = [
    { r: 16, color: "#EF4444", d: 0 }, { r: 13, color: "#F59E0B", d: 0.1 },
    { r: 10, color: "#22C55E", d: 0.2 }, { r: 7, color: "#3B82F6", d: 0.3 },
  ];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
      {arcs.map((arc) => (
